...
<?php
	...
	?>
				<script type="text/javascript">
					toastr.error('Gambar gagal diunggah.', 'ERROR', {timeOut: 5000});
				</script> 
	<?php
			}
		}
	...
	?>
			<script type="text/javascript">
				toastr.error('Ada kesalahan pada gambar.', 'ERROR', {timeOut: 5000});
			</script> 
	<?php
		}
	}
	...
	if (isset($_POST['start']))
	{
		...
		if ($result === TRUE) 
		{
			?>
			<script>
				window.open('https://www.learn4good.com/kids-games/cars/traffic-jam-driving-games.htm', '_blank');
			</script>
			<?php
		}
		else
		{
			?>
			<script type="text/javascript">
				toastr.error('Ada pada link. Mohon menghubungi admin/developer.', 'ERROR', {timeOut: 5000});
			</script> 
			<?php
		}
	}
...
<header class="w3-display-container w3-content w3-wide" style="max-width:1250px;" id="home">
  ...
  <div class="w3-display-middle w3-margin-top w3-center">
    <h1 class="w3-xxlarge w3-text-white"><span class="w3-padding w3-black w3-opacity-min"><b>Rush Hour</b></span>
  </div>
</header>
